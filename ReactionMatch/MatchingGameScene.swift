...
class MatchingGameScene: SKScene {
    ...
    fileprivate func getTargetShapeNodeFor(_ playerNodeColor: TargetColor, playerNodeShape: TargetShape, isWinning: Bool) -> TargetShapeNode {
    ...
    fileprivate func player(_ playerNode: TargetShapeNode, didSelectCorrectTarget correctTarget: TargetShapeNode, withIncorrectTargets incorrectTargets: [TargetShapeNode]) {
    ...
    fileprivate func getCollisionStateForPlayer(_ playerNode: TargetShapeNode, withCorrectTarget correctTarget: TargetShapeNode, andIncorrectTargets incorrectTargets: [TargetShapeNode]) -> PlayerCollisionState {
    ...
    fileprivate func player(_ playerNode: TargetShapeNode, didEndMoveWithCorrectTarget correctTarget: TargetShapeNode, andIncorrectTargets incorrectTargets: [TargetShapeNode]) {
        let collisionState = getCollisionStateForPlayer(playerNode, withCorrectTarget: correctTarget, andIncorrectTargets: incorrectTargets)
